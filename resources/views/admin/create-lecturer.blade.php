...
@section('content')
    ...
    <div class="main-container">
        ...
        <div class="header-section">
            ...
            <p>Add a new lecturer to the system</p>
        </div>
        ...
        <div class="content-section">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.store-lecturer') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row form-row">
                            ...
                            <div class="col-md-6">
                                <label for="staff_id" class="form-label">Staff ID <small class="text-muted">(Optional - will
                                        be auto-generated if left empty)</small></label>
                                <input type="text" class="form-control @error('staff_id') is-invalid @enderror"
                                    id="staff_id" name="staff_id" value="{{ old('staff_id') }}">
                                @error('staff_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">Format example: 2023/STAFF/CSC/0001</div>
                            </div>
                        </div>
