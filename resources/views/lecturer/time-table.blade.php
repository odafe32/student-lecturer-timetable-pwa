        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex flex-col justify-content-between align-items-center">
                    <div>
                        <h3 class="h3 mb-0 text-gray-800">Timetable Management</h3>
                        <p class="text-muted mb-0">Manage your class schedules </p>
                    </div>
                    <div>
                                                        ...
                                                        <tr>
                                                            @if ($loop->first)
                                                                <td class="align-middle fw-bold"
                                                                    rowspan="{{ $weeklySchedule[$day]->count() }}">
                                                                    {{ $dayNames[$index] }}
                                                                </td>
                                                            @endif
                                                            <td>
                                            ...
                                            @if (!$hasClasses)
                                                <tr>
                                                    <td colspan="6" class="text-center py-4">
                                                        ...
                                                        <a href="{{ route('lecturer.timetable.create') }}"
                                        ...
                                        <div class="card mobile-timetable-card">
                                            <div class="card-body">
                                                ...
                                                <div class="schedule-info mb-2">
                                                    <div><i
                                                            class="bi bi-calendar me-1"></i>{{ $timetable->formatted_day ?? '' }}
                                                    </div>
                                                    <div><i
                                                            class="bi bi-clock me-1"></i>{{ $timetable->time_range ?? '' }}
                                                    </div>
                                                ...
                                                <div class="small text-muted mb-3">
                                                    {{ $timetable->completed_sessions }} of
                                                    {{ $timetable->total_sessions }} sessions completed
                                                </div>
