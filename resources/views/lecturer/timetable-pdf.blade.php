                    ...
                    <tbody>
                        @foreach ($weeklySchedule[$day] as $timetable)
                            <tr>
                                ...
                                <td>
                                    <div class="course-code">{{ $timetable->course_code ?? $timetable->course->course_code }}</div>
                                    <div class="course-title">{{ $timetable->course_title ?? $timetable->course->course_title }}</div>
                                </td>
